...
object AppConstant {
    ...
    const val COL_PRODUCT_CART_PRODUCT_PRICE = "product_price"
    const val COL_PRODUCT_CART_PRODUCT_IMAGE = "product_image"
    const val COL_PRODUCT_CART_PRODUCT_STOCK = "product_stock"
